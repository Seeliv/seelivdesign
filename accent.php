...
<section class="side-bar">
  <div class="side-bar-content">
    ...
    <ul class="fa-ul">
                                <li><a class="active" href="#"><span class="fa-li"><i class="fas fa-volume-up"></i></span>Accent</a></li>
                                ...
                                <li><a href="#"><span class="fa-li"><i class="fas fa-microphone-alt"></i>Mother Tongue</a></li>
