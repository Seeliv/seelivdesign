...
<section class="side-bar">
  <div class="side-bar-content">
    ...
    <ul class="fa-ul">
                                ...
                                <li><a href="SchoolIntro.php"><span class="fa-li"><img src="images/icon26.png"></span> School Introduction</a></li>
                                ...
                                <li><a class="active" href="#"><span class="fa-li"><img src="images/icon7.png"></span> slide Bar (2)</a></li>
                          </ul>
                          </div>
  </div>
</section>
<div class="content">
  ...
  <div class="content-in">
    <div class="content-fix-head"><h1>Slide Bar (2)</h1></div>
    <div class="main-content">
      <div class="card-body noticeboard">
                <div class="header_message sec2wrap btnwap">
                  ...
                  <div class="slide-picture"><img src="images/side2.png" /></div>
                   </div>
                  <div class="header_message sec2wrap btnwap">
                    <div class="card-wrap">
                     <div class="card-message">
