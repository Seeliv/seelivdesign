...
<title>Monitor Account Name</title>
<?php include("head.php") ?>
</head>

<body>
<?php include("Admin_monitor_header.php"); ?>
<main>
    ...
    <div class="content-fix-head">
       ...
       <div class="table-options">
         ...
         <div class="sort-option">
           ...
           <ul>
             <li><button class="sort-button active">Monitoring In Pending</button></li>
             <li><button class="sort-button">Monitoring Completed</button></li>
