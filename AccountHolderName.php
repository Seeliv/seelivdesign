...
<section class="side-bar">
  <div class="side-bar-content">
    ...
    <ul class="fa-ul">
                                <li><a class="active" href="AccountHolderName.php"><span class="fa-li"><img src="images/icon19.png"></span> Account Holder Name</a></li>
...
<div class="content">
  ...
  <div class="content-in">
    <div class="content-fix-head"><h1>Account Holder Name</h1></div>
