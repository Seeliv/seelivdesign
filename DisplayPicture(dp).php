...
<section class="side-bar">
  <div class="side-bar-content">
    ...
    <ul class="fa-ul">
                                <li><a href="AccountHolderName.php"><span class="fa-li"><img src="images/icon19.png"></span> Account Holder Name</a></li>
                                <li><a class="active" href="#"><span class="fa-li"><img src="images/icon1.png"></span> Display Picture (dp)</a></li>
                                <li><a href="CoverPhoto(cp).php"><span class="fa-li"><img src="images/icon2.png"></span>Cover Photo (cp)</a></li>
                                <li><a href="SchoolNam &Abbreviation.php"><span class="fa-li"><img src="images/icon26.png"></span> School Name &amp; Abbreviation</a></li>
                                <li><a href="#"><span class="fa-li"><img src="images/icon3.png"></span> Notice Board</a></li>
...
<div class="content">
  ...
  <div class="content-in">
    <div class="content-fix-head"><h1>Display Picture (Dp)</h1></div>
    <div class="main-content">
      <div class="card-body noticeboard">
                <div class="header_message sec2wrap btnwap">
                    ...
                    <div class="message">
                         <p>General Account Default Dp</p>
                       </div>
                  </div>
                  ...
                  <div class="display-picture"><img src="images/side.png" /></div>
                   </div>
                  <div class="header_message sec2wrap btnwap">
                    <div class="card-wrap">
                     <div class="card-message">
                    <div class="message">
                         <p>School Account Default Dp</p>
                       </div>
                  </div>
                     <div class="card-option">
                    <div class="sidebtn ">
