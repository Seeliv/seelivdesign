...
<section class="side-bar">
  <div class="side-bar-content">
    ...
    <ul class="fa-ul">
                                ...
                                <li><a class="active" href="#"><span class="fa-li"><img src="images/icon26.png"></span> School Name &amp; Abbreviation</a></li>
...
<div class="content">
  ...
  <div class="content-in">
    <div class="content-fix-head"><h1>School Name & Abbreviation</h1></div>
    <div class="main-content">
      <div class="card-body noticeboard">
                <div class="header_message sec2wrap btnwap">
                    ...
                    <div class="message">
                         <p>School Name<br>
                        <span class="mintext">Unverified User</span></p>
                       </div>
                  </div>
                   ...
                   <div class="header_message sec2wrap btnwap">
                    <div class="card-wrap">
                     <div class="card-message">
                    <div class="message">
                         <p>School Name Abberviation<br>
                        <span class="mintext">SLV</span></p>
                       </div>
                  </div>
                     <div class="card-option">
                    <div class="sidebtn ">
